...
module.exports = {
  URLS: {
    GIS: 'http://images.google.com/',
    GOOGLE: 'http://www.google.com/',
    W_GOOGLE: 'http://www.google.com/',
    GOOGLE_NEWS: 'http://news.google.com/',
    FAVICONKIT: 'http://api.faviconkit.com'
  },
  SELECTORS: {
    // Organic Search Results 
    TITLE: 'h3.LC20lb.MBeuO.DKV0Md',
    DESCRIPTION: 'div.VwiC3b.yXK7lf.MUxGbd.yDYNvb.lyLwlc.lEBKkf',
    URL: 'div.kb0PBd.cvP2Ce.jGGQ5e > div > div > a',
